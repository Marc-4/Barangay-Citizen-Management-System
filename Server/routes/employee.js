...
// router.patch('/account/edit', middlewares, Employee.editEmployeeController)
...
router.get('/user/all/', middlewares, Employee.getUsersController)
router.get('/user/Profile/:id', middlewares, Employee.getUserProfileController)
router.get('/user/Profile/all', middlewares, Employee.getUserProfilesController)
...
router.get('/transaction/all', middlewares, Employee.getAllTransactionsController)
